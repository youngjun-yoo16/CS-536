...
This runs all algorithms at 2, 4, and 8 ranks, sweeping over message sizes from 1KB up to 128MB. It also generates plots at the end.
...
# cap message size at 4MB instead of 128MB (faster)
