...
Most users should invoke the **top-level driver** at `hw2/main.py`, which
orchestrates:

- `client/main.py` for iperf tests and trace collection,
- `client/plot.py` for Q1/Q2 PDF plots,
- `client/ml_pipeline.py` for Q3 ML training and cwnd plots.

See the `hw2/README.md` for full details and example commands.
